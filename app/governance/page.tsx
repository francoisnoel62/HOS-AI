...
export default function GovernancePage() {
  return (
    <>
      <PageHero
        eyebrow="Governance"
        title="Build the commons in public, then steward it independently."
        description="HOS AI is an early-stage initiative working toward an independent HOS Foundation that aims to make hospitality operations interoperable, trustworthy and agent-ready."
        badge="Early-stage initiative"
      />
      <SectionFrame eyebrow="Public commitments" title="Neutrality is a practice, not a claim.">
        <div className="grid gap-4 md:grid-cols-2">
          {[
            [
              "Open standard",
              "The specification text is published under CC BY 4.0; schemas and code use Apache-2.0. Marks and editorial content remain separately protected.",
            ],
            ...
            [
              ...
              "Funding, code and early contribution do not create exclusive rights over the standard, data or certification.",
            ],
          ].map(([title, text]) => (
        ...
        <ol className="grid gap-3 md:grid-cols-3">
          <li className="border-l-2 border-[var(--accent)] pl-4">
            ...
            <p className="mt-2 text-sm leading-6 text-[var(--muted-foreground)]">
              Publish a clear charter, public artefacts and a path for qualified participants.
            </p>
          </li>
          <li className="border-l-2 border-[var(--border-strong)] pl-4">
            <p className="eyebrow">Formation</p>
            <p className="mt-2 text-sm leading-6 text-[var(--muted-foreground)]">
              Convene independent organisations across hospitality operations, PMS and the wider ecosystem.
            </p>
          </li>
          <li className="border-l-2 border-[var(--border-strong)] pl-4">
            <p className="eyebrow">Destination</p>
            <p className="mt-2 text-sm leading-6 text-[var(--muted-foreground)]">
              Transfer stewardship to an independent HOS Association aligned with the public commitments.
            </p>
          </li>
        </ol>
        <Link className="mt-10 inline-block" href="/manifesto">
