...
export const scenarioDemos: Record<ConformanceScenarioId, ScenarioDemo> = {
  "arrival-readiness": {
    ...
    metaDescription:
      "Step through thirteen updates from a PMS, a housekeeping system and guest messaging, with made-up data, and watch HOS raise, then clear, an alert when a guest arriving early meets a room that is not ready.",
  },
  "room-out-of-order": {
    ...
    metaDescription:
      "Step through fourteen updates from a PMS, a housekeeping system and a maintenance system, with made-up data, and watch HOS raise, then clear, an alert when a guest's room goes out of order on the day of arrival.",
  },
  "late-checkout": {
    ...
    metaDescription:
      "Step through fifteen updates from a PMS and a housekeeping system, with made-up data, and watch HOS raise, then clear, an alert when a late check-out overlaps a same-day arrival in the same room.",
  },
};
