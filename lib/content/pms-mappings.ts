...
export const pmsComparison = [
  ...
  ["What HOS 0.1 gained from it", "stay.unit_unassigned, hostimebasis modified", "stay.unit_unassigned, stay.check_in_reverted, the guest identity rule", "stay.unit_unassigned, hosactor, standard check-in and check-out times"],
